...
/*
A LidarPoint is a container to hold an intersection coordinate, the ray that was cast to obtain this intersection, a flag to indicate if the point is a valid scene intersection, and the normal of the triangle of the scene that was intersected by this ray
*/
...
class vtkLidarPoint : public vtkObject
{
	public:
		...
		vtkRay* GetRay(); //get the ray that was/will be cast into the scene
